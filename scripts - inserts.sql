...
(nextval('seq_idioma'), 'Chino Mandarín'),
(nextval('seq_idioma'), 'Español'),
(nextval('seq_idioma'), 'Inglés'),
(nextval('seq_idioma'), 'Hindi'),
(nextval('seq_idioma'), 'Árabe'),
(nextval('seq_idioma'), 'Bengalí'),
(nextval('seq_idioma'), 'Portugués'),
(nextval('seq_idioma'), 'Ruso'),
(nextval('seq_idioma'), 'Japonés'),
(nextval('seq_idioma'), 'Lahnda (Punjabi)'),
(nextval('seq_idioma'), 'Javanés'),
(nextval('seq_idioma'), 'Alemán'),
(nextval('seq_idioma'), 'Coreano'),
(nextval('seq_idioma'), 'Francés'),
(nextval('seq_idioma'), 'Telugu'),
(nextval('seq_idioma'), 'Marathi'),
(nextval('seq_idioma'), 'Turco'),
(nextval('seq_idioma'), 'Tamil'),
(nextval('seq_idioma'), 'Urdu'),
(nextval('seq_idioma'), 'Vietnamita');
...
(nextval('seq_empleado_prof'), 'Amby', 'Vasnev', 'Ethelin', 'Mannix', '7/26/1965', 37199014, 'emannix0@cdc.gov'),
(nextval('seq_empleado_prof'), 'Phillida', 'Millward', 'Anissa', 'Boggas', '4/25/1988', 98720528, 'aboggas1@last.fm'),
(nextval('seq_empleado_prof'), 'Audra', 'Anders', 'Howey', 'Dauby', '3/27/1992', 3577167, 'hdauby2@uiuc.edu'),
(nextval('seq_empleado_prof'), 'Marcy', 'Lotte', 'Izzy', 'Upcott', '8/26/1965', 62756151, 'iupcott3@ted.com'),
(nextval('seq_empleado_prof'), 'Kriste', 'Dowd', 'Valentina', 'Antonucci', '8/17/1986', 84191792, 'vantonucci4@creativecommons.org'),
(nextval('seq_empleado_prof'), 'Illa', 'Maddy', 'Clim', 'Jilliss', '4/13/2003', 76188238, 'cjilliss5@cpanel.net'),
(nextval('seq_empleado_prof'), 'Deny', 'Wandrack', 'Karlee', 'Tutill', '10/8/1977', 11723682, 'ktutill6@nasa.gov'),
(nextval('seq_empleado_prof'), 'Alanson', 'Khosa', 'Ferne', 'Wolvey', '2/21/2003', 70089698, 'fwolvey7@bigcartel.com'),
(nextval('seq_empleado_prof'), 'Antony', 'Kelwaybamber', 'Cassandra', 'Kempster', '11/4/1990', 14461178, 'ckempster8@bbc.co.uk'),
(nextval('seq_empleado_prof'), 'Ame', 'Weatherall', 'Juanita', 'Tinman', '2/1/1967', 46210895, 'jtinman9@fastcompany.com'),
(nextval('seq_empleado_prof'), 'Samaria', 'Ouldcott', 'Orville', 'Haw', '11/25/1972', 80969176, 'ohawa@seesaa.net'),
(nextval('seq_empleado_prof'), 'Lonnie', 'Staniforth', 'Melisa', 'Kumar', '11/25/1973', 75595309, 'mkumarb@comcast.net'),
(nextval('seq_empleado_prof'), 'Wadsworth', 'Brannigan', 'Sammie', 'Balasin', '2/27/1977', 24585802, 'sbalasinc@marketwatch.com'),
(nextval('seq_empleado_prof'), 'Chere', 'Sorbie', 'Rozalin', 'McCahill', '11/15/1980', 16540658, 'rmccahilld@netvibes.com'),
(nextval('seq_empleado_prof'), 'Binky', 'Sedman', 'Erny', 'Duffie', '1/31/1971', 25003704, 'eduffiee@gov.uk'),
(nextval('seq_empleado_prof'), 'Luella', 'Dugmore', 'Audrye', 'Vescovini', '2/20/1971', 35887091, 'avescovinif@ow.ly'),
(nextval('seq_empleado_prof'), 'Amalita', 'Sandyford', 'Vladamir', 'MacGray', '7/3/1985', 33916912, 'vmacgrayg@webnode.com'),
(nextval('seq_empleado_prof'), 'Francklyn', 'Posthill', 'Carol', 'Roylance', '5/23/1981', 39481127, 'croylanceh@issuu.com'),
(nextval('seq_empleado_prof'), 'Ephrayim', 'Loins', 'Gottfried', 'Perren', '12/25/1972', 68820889, 'gperreni@github.io'),
(nextval('seq_empleado_prof'), 'Oliy', 'Leander', 'Ursulina', 'Langelay', '5/7/1986', 31800030, 'ulangelayj@tripadvisor.com'),
(nextval('seq_empleado_prof'), 'Ingra', 'Snaddon', 'Cam', 'Raywood', '5/26/1978', 9485591, 'craywoodk@sourceforge.net'),
(nextval('seq_empleado_prof'), 'Alecia', 'Kingcott', 'Karleen', 'Chatelot', '5/11/1994', 56219159, 'kchatelotl@4shared.com'),
(nextval('seq_empleado_prof'), 'Connor', 'Fyfield', 'Kipp', 'Lurcock', '6/18/1986', 73216351, 'klurcockm@github.io'),
(nextval('seq_empleado_prof'), 'Laney', 'Emanuelov', 'Chanda', 'McAllan', '10/12/1987', 61107397, 'cmcallann@dion.ne.jp'),
(nextval('seq_empleado_prof'), 'Trevor', 'Iglesias', 'Sophia', 'Wadham', '6/30/2000', 4318989, 'swadhamo@uiuc.edu'),
(nextval('seq_empleado_prof'), 'Inger', 'Laite', 'Rawley', 'Kempshall', '11/26/1964', 62349446, 'rkempshallp@who.int'),
(nextval('seq_empleado_prof'), 'Daisi', 'Newborn', 'Tate', 'Dewer', '8/29/1996', 83959955, 'tdewerq@state.gov'),
(nextval('seq_empleado_prof'), 'Marcille', 'Haborn', 'Tanya', 'Polley', '12/5/1984', 64120783, 'tpolleyr@yelp.com'),
(nextval('seq_empleado_prof'), 'Dolf', 'Sandal', 'Ddene', 'Este', '9/20/1965', 36553430, 'destes@latimes.com'),
(nextval('seq_empleado_prof'), 'Kaylyn', 'Blader', 'Dolf', 'Mulcock', '4/1/1965', 76810772, 'dmulcockt@photobucket.com'),
(nextval('seq_empleado_prof'), 'Pooh', 'Parkey', 'Parry', 'Bikker', '4/22/1974', 9110987, 'pbikkeru@theglobeandmail.com'),
(nextval('seq_empleado_prof'), 'Riane', 'Dodson', 'Mikey', 'Pace', '9/29/1990', 54248052, 'mpacev@mit.edu'),
(nextval('seq_empleado_prof'), 'Harwell', 'Grigore', 'Allix', 'Couche', '8/2/1989', 67729855, 'acouchew@delicious.com'),
(nextval('seq_empleado_prof'), 'Concettina', 'Deschlein', 'Alonzo', 'Ixer', '7/15/1983', 86901830, 'aixerx@php.net'),
(nextval('seq_empleado_prof'), 'Olga', 'Dumphries', 'Elianora', 'Caris', '8/6/1972', 69560630, 'ecarisy@prnewswire.com'),
(nextval('seq_empleado_prof'), 'Mindy', 'Pratten', 'Noach', 'Bairnsfather', '6/17/1992', 87951313, 'nbairnsfatherz@booking.com'),
(nextval('seq_empleado_prof'), 'Edd', 'Anten', 'Zachariah', 'Snelle', '11/10/1979', 13958779, 'zsnelle10@ibm.com'),
(nextval('seq_empleado_prof'), 'Oralee', 'Szabo', 'Joela', 'Top', '7/4/1985', 39712868, 'jtop11@lycos.com'),
(nextval('seq_empleado_prof'), 'Ive', 'Sultan', 'Margalo', 'Late', '8/6/1968', 68001922, 'mlate12@chron.com'),
(nextval('seq_empleado_prof'), 'Agosto', 'Shevlane', 'Vida', 'Selkirk', '6/9/1969', 86983568, 'vselkirk13@ucoz.ru'),
(nextval('seq_empleado_prof'), 'Zerk', 'Perassi', 'Blanch', 'Creed', '7/30/1976', 99920354, 'bcreed14@wikipedia.org'),
(nextval('seq_empleado_prof'), 'Joni', 'Habron', 'Netta', 'Baldry', '3/26/1979', 73689447, 'nbaldry15@un.org'),
(nextval('seq_empleado_prof'), 'Cybill', 'Rimour', 'Janette', 'Monroe', '7/9/1992', 95766817, 'jmonroe16@archive.org'),
(nextval('seq_empleado_prof'), 'Nicky', 'Kenen', 'Klement', 'O''Geneay', '8/19/1973', 94199855, 'kogeneay17@webmd.com'),
(nextval('seq_empleado_prof'), 'Imelda', 'Gillard', 'Aleen', 'Mantrup', '12/12/1971', 19023592, 'amantrup18@posterous.com'),
(nextval('seq_empleado_prof'), 'Margarita', 'Fishbourn', 'Lorena', 'Looney', '8/24/2001', 8057751, 'llooney19@state.tx.us'),
(nextval('seq_empleado_prof'), 'Raymund', 'McLarty', 'Burgess', 'Reubel', '12/5/1983', 92672845, 'breubel1a@blogs.com'),
(nextval('seq_empleado_prof'), 'Geno', 'McOnie', 'Dre', 'Jeandeau', '12/7/1996', 98416475, 'djeandeau1b@moonfruit.com'),
(nextval('seq_empleado_prof'), 'Giovanna', 'Featherby', 'Jorgan', 'Philliskirk', '7/24/1971', 1588698, 'jphilliskirk1c@buzzfeed.com'),
(nextval('seq_empleado_prof'), 'Gard', 'Scandred', 'Eliza', 'Towey', '2/13/1974', 87309340, 'etowey1d@bloglovin.com'),
(nextval('seq_empleado_prof'), 'Phyllida', 'Biasioli', 'Rog', 'Cordel', '11/6/1994', 27435442, 'rcordel1e@imgur.com'),
(nextval('seq_empleado_prof'), 'Sean', 'Aleksandrikin', 'Merrilee', 'Kochl', '7/27/1984', 14399168, 'mkochl1f@cbc.ca'),
(nextval('seq_empleado_prof'), 'Sena', 'Tallon', 'Ashlie', 'Hedaux', '1/23/1980', 92188237, 'ahedaux1g@sfgate.com'),
(nextval('seq_empleado_prof'), 'Haze', 'Haley', 'Patti', 'Newvill', '1/7/1976', 60924864, 'pnewvill1h@businessinsider.com'),
(nextval('seq_empleado_prof'), 'Patin', 'Poznanski', 'Ashton', 'Ogan', '8/20/1990', 80438553, 'aogan1i@chicagotribune.com'),
(nextval('seq_empleado_prof'), 'Sydney', 'Houlston', 'Cortie', 'Gofford', '4/7/1969', 34071060, 'cgofford1j@msn.com'),
(nextval('seq_empleado_prof'), 'Pamelina', 'Ivashov', 'Gayle', 'Harbison', '10/14/1966', 64090908, 'gharbison1k@ca.gov'),
(nextval('seq_empleado_prof'), 'Renault', 'Wildblood', 'Rozamond', 'Phin', '6/21/1999', 86487467, 'rphin1l@imageshack.us'),
(nextval('seq_empleado_prof'), 'Cointon', 'Tommasuzzi', 'Aubrie', 'Beckett', '12/2/1988', 57368415, 'abeckett1m@usnews.com'),
(nextval('seq_empleado_prof'), 'Menard', 'Degoe', 'Martynne', 'Redrup', '11/3/1975', 73630413, 'mredrup1n@google.co.uk'),
(nextval('seq_empleado_prof'), 'Theresa', 'Ellison', 'Bryana', 'Pawel', '1/13/2002', 82852819, 'bpawel1o@imgur.com'),
(nextval('seq_empleado_prof'), 'Urban', 'Shire', 'Ladonna', 'Sharer', '2/3/1966', 6032421, 'lsharer1p@mozilla.org'),
(nextval('seq_empleado_prof'), 'Adrianne', 'Newland', 'Shirlene', 'Dart', '4/1/1987', 39355796, 'sdart1q@hp.com'),
(nextval('seq_empleado_prof'), 'Early', 'Wackly', 'Mariellen', 'Cobello', '3/4/2005', 11970919, 'mcobello1r@shop-pro.jp'),
(nextval('seq_empleado_prof'), 'Megan', 'MacCurley', 'Nev', 'Friday', '8/21/1993', 79991413, 'nfriday1s@bbc.co.uk'),
(nextval('seq_empleado_prof'), 'Hana', 'Todarini', 'Philippa', 'Craufurd', '5/5/1993', 41040935, 'pcraufurd1t@friendfeed.com'),
(nextval('seq_empleado_prof'), 'Rodrigo', 'Kenwyn', 'Lodovico', 'Cornelis', '2/3/1974', 29573757, 'lcornelis1u@nymag.com'),
(nextval('seq_empleado_prof'), 'Trevor', 'Terbrug', 'Rebecka', 'Clampett', '6/30/1973', 30463135, 'rclampett1v@washingtonpost.com'),
(nextval('seq_empleado_prof'), 'Kelsy', 'Geerdts', 'Raquela', 'Strutz', '2/26/1998', 14065028, 'rstrutz1w@chronoengine.com'),
(nextval('seq_empleado_prof'), 'Tanner', 'Carsberg', 'Fonsie', 'Bruhnke', '1/24/1983', 75932398, 'fbruhnke1x@bloglines.com'),
(nextval('seq_empleado_prof'), 'Charlotte', 'Alasdair', 'Jackqueline', 'Kelbie', '3/25/1968', 10756490, 'jkelbie1y@bandcamp.com'),
(nextval('seq_empleado_prof'), 'Levin', 'Feragh', 'Bearnard', 'Wooff', '7/18/1983', 69904701, 'bwooff1z@facebook.com'),
(nextval('seq_empleado_prof'), 'Wynn', 'Jean', 'Cassandra', 'Boutwell', '9/30/1967', 71620106, 'cboutwell20@macromedia.com'),
(nextval('seq_empleado_prof'), 'Tonya', 'Gully', 'Erastus', 'Philpot', '6/7/1996', 14017075, 'ephilpot21@cnn.com'),
(nextval('seq_empleado_prof'), 'Scott', 'Dinnage', 'Spenser', 'Trundle', '7/3/1964', 70042173, 'strundle22@icq.com'),
(nextval('seq_empleado_prof'), 'Myrta', 'Benediktsson', 'Thacher', 'Demange', '8/3/2004', 10732182, 'tdemange23@bbb.org'),
(nextval('seq_empleado_prof'), 'Mariellen', 'Gerrard', 'Janaye', 'Gilyatt', '6/26/2001', 83494777, 'jgilyatt24@about.me'),
(nextval('seq_empleado_prof'), 'Gearard', 'Goodding', 'Nara', 'Stronack', '9/19/1973', 83728547, 'nstronack25@nytimes.com'),
(nextval('seq_empleado_prof'), 'Case', 'Chesterfield', 'Wileen', 'Rodolf', '7/1/1987', 73883122, 'wrodolf26@loc.gov'),
(nextval('seq_empleado_prof'), 'Webster', 'Coutthart', 'Perla', 'Wakes', '8/3/1982', 2840559, 'pwakes27@webeden.co.uk'),
(nextval('seq_empleado_prof'), 'Leah', 'Yelyashev', 'Rhea', 'Mortel', '7/7/1975', 84133153, 'rmortel28@hexun.com'),
(nextval('seq_empleado_prof'), 'Jamey', 'Shawley', 'Mozelle', 'Corradeschi', '3/18/1987', 87040195, 'mcorradeschi29@cbslocal.com'),
(nextval('seq_empleado_prof'), 'Torie', 'Barcroft', 'Jeannine', 'Tanton', '12/7/1975', 88042923, 'jtanton2a@ifeng.com'),
(nextval('seq_empleado_prof'), 'Babette', 'Tylor', 'Kandace', 'Letherbury', '5/10/1985', 54959418, 'kletherbury2b@istockphoto.com'),
(nextval('seq_empleado_prof'), 'Sidnee', 'Hawtin', 'Candra', 'Van Brug', '11/22/1994', 73371005, 'cvanbrug2c@amazon.co.jp'),
(nextval('seq_empleado_prof'), 'Anica', 'Watsam', 'Valentin', 'Slyde', '3/6/1985', 22335186, 'vslyde2d@skype.com'),
(nextval('seq_empleado_prof'), 'Elroy', 'Booij', 'Lucille', 'McMackin', '2/28/1992', 26560145, 'lmcmackin2e@seesaa.net'),
(nextval('seq_empleado_prof'), 'Erna', 'Coulthard', 'Rutter', 'Rabbitts', '7/20/1990', 33462118, 'rrabbitts2f@stumbleupon.com'),
(nextval('seq_empleado_prof'), 'Lamar', 'Coult', 'Magdalene', 'Heine', '3/14/1971', 23593509, 'mheine2g@buzzfeed.com'),
(nextval('seq_empleado_prof'), 'Gayla', 'Dailly', 'Cornall', 'Brisset', '3/4/1986', 79368846, 'cbrisset2h@sbwire.com'),
(nextval('seq_empleado_prof'), 'Putnem', 'Cornforth', 'Agnese', 'Comiam', '3/4/1988', 97934565, 'acomiam2i@sakura.ne.jp'),
(nextval('seq_empleado_prof'), 'Lynette', 'Pengilly', 'Johnnie', 'Munkley', '6/25/1995', 39277718, 'jmunkley2j@weather.com'),
(nextval('seq_empleado_prof'), 'Harriet', 'Voisey', 'Mathilde', 'Colston', '9/1/1979', 98499867, 'mcolston2k@nyu.edu'),
(nextval('seq_empleado_prof'), 'Elroy', 'Mauger', 'Abba', 'Nestoruk', '8/20/1977', 66392294, 'anestoruk2l@gnu.org'),
(nextval('seq_empleado_prof'), 'Quill', 'Eastmond', 'Reube', 'Chantrell', '11/12/1995', 30244655, 'rchantrell2m@goo.gl'),
(nextval('seq_empleado_prof'), 'Skyler', 'Fetherstonhaugh', 'Noam', 'Womack', '6/9/1966', 40847902, 'nwomack2n@un.org'),
(nextval('seq_empleado_prof'), 'Shaine', 'Comley', 'Prinz', 'Van Haeften', '1/16/1999', 5100504, 'pvanhaeften2o@unicef.org'),
(nextval('seq_empleado_prof'), 'Berti', 'Checklin', 'Leland', 'Frostdicke', '6/1/1983', 15978800, 'lfrostdicke2p@exblog.jp'),
(nextval('seq_empleado_prof'), 'Ruttger', 'Wolpert', 'Paige', 'Jeynes', '7/19/1998', 87503451, 'pjeynes2q@so-net.ne.jp'),
(nextval('seq_empleado_prof'), 'Hamel', 'Seeney', 'Fredek', 'Buske', '9/2/1990', 13541151, 'fbuske2r@patch.com'),
(nextval('seq_empleado_prof'), 'Kelvin', 'Pieche', 'Esteban', 'Corden', '11/17/1986', 97862915, 'ecorden2s@skyrock.com'),
(nextval('seq_empleado_prof'), 'May', 'Pyzer', 'Theodore', 'Danher', '7/15/1972', 43393188, 'tdanher2t@yolasite.com'),
(nextval('seq_empleado_prof'), 'Karie', 'Maymand', 'Viola', 'Ivy', '10/17/1988', 75295006, 'vivy2u@bluehost.com'),
(nextval('seq_empleado_prof'), 'See', 'Wintersgill', 'Fredericka', 'Zanetto', '12/21/1979', 20393814, 'fzanetto2v@hud.gov'),
(nextval('seq_empleado_prof'), 'Casie', 'Toppin', 'Gizela', 'Cromb', '11/11/1975', 38009356, 'gcromb2w@arstechnica.com'),
(nextval('seq_empleado_prof'), 'Ines', 'Tivers', 'Lock', 'O''Donnelly', '7/31/1977', 13774010, 'lodonnelly2x@icio.us'),
(nextval('seq_empleado_prof'), 'Eddie', 'Brian', 'Rollo', 'Berney', '8/24/1981', 43162133, 'rberney2y@businessinsider.com'),
(nextval('seq_empleado_prof'), 'Ryley', 'Barmadier', 'Morton', 'Antushev', '4/8/1986', 4847718, 'mantushev2z@bravesites.com'),
(nextval('seq_empleado_prof'), 'Bronny', 'Logue', 'Rafaelita', 'Flag', '11/13/2000', 48349335, 'rflag30@europa.eu'),
(nextval('seq_empleado_prof'), 'Layne', 'Meese', 'Eugen', 'Breward', '10/19/1972', 48574848, 'ebreward31@springer.com'),
(nextval('seq_empleado_prof'), 'Susan', 'Worwood', 'Katerine', 'Simony', '1/1/1974', 21756369, 'ksimony32@vk.com'),
(nextval('seq_empleado_prof'), 'Anson', 'Rosone', 'Hube', 'Spykings', '12/18/2000', 40994312, 'hspykings33@gizmodo.com'),
(nextval('seq_empleado_prof'), 'Adora', 'Gerbi', 'Duffy', 'McMenamy', '7/17/1964', 20930410, 'dmcmenamy34@mozilla.org'),
(nextval('seq_empleado_prof'), 'Danny', 'Scandwright', 'Deedee', 'Saunderson', '1/21/1971', 40469472, 'dsaunderson35@alibaba.com'),
(nextval('seq_empleado_prof'), 'Ethyl', 'Havesides', 'Skippie', 'Ellingworth', '9/12/1982', 30187072, 'sellingworth36@shutterfly.com'),
(nextval('seq_empleado_prof'), 'Berkeley', 'Siddle', 'Lorne', 'Fosberry', '2/11/1982', 92386958, 'lfosberry37@businessinsider.com'),
(nextval('seq_empleado_prof'), 'Valentine', 'Priditt', 'Augustine', 'Chesters', '11/26/1966', 20769162, 'achesters38@webeden.co.uk'),
(nextval('seq_empleado_prof'), 'Grover', 'Whelpton', 'Zedekiah', 'Bonanno', '6/11/2002', 65464708, 'zbonanno39@bigcartel.com'),
(nextval('seq_empleado_prof'), 'Ola', 'Dinzey', 'Chrysler', 'Pigdon', '7/17/2001', 2163110, 'cpigdon3a@fda.gov'),
(nextval('seq_empleado_prof'), 'Reggy', 'MacGaughy', 'Wallache', 'Ottam', '4/13/2004', 69593875, 'wottam3b@wsj.com'),
(nextval('seq_empleado_prof'), 'Bernardo', 'Crusham', 'Lonna', 'Fawssett', '9/19/2002', 26438734, 'lfawssett3c@jimdo.com'),
(nextval('seq_empleado_prof'), 'Alberta', 'Swinden', 'Brear', 'Lanfranconi', '4/16/2003', 26650659, 'blanfranconi3d@ucoz.ru'),
(nextval('seq_empleado_prof'), 'Braden', 'Cheese', 'Monty', 'Pountain', '2/4/1980', 13177378, 'mpountain3e@admin.ch'),
(nextval('seq_empleado_prof'), 'Davide', 'Wildsmith', 'Xylia', 'Stokoe', '1/3/1992', 93010574, 'xstokoe3f@epa.gov'),
(nextval('seq_empleado_prof'), 'Bendite', 'Nasey', 'Janean', 'Horry', '5/14/1967', 26099952, 'jhorry3g@reference.com'),
(nextval('seq_empleado_prof'), 'Keslie', 'Yokley', 'Nomi', 'Biaggiotti', '12/17/1976', 56420426, 'nbiaggiotti3h@forbes.com'),
(nextval('seq_empleado_prof'), 'Thatch', 'Diboll', 'Eran', 'Keaves', '8/11/2003', 28499733, 'ekeaves3i@blogs.com'),
(nextval('seq_empleado_prof'), 'Wilton', 'Baum', 'Rudie', 'Trevorrow', '8/14/1995', 74234661, 'rtrevorrow3j@drupal.org'),
(nextval('seq_empleado_prof'), 'Bennie', 'Luetchford', 'Harlene', 'Patrie', '11/11/1992', 79569943, 'hpatrie3k@hud.gov'),
(nextval('seq_empleado_prof'), 'Worthy', 'Obal', 'Shepherd', 'Pemberton', '4/28/1981', 91689680, 'spemberton3l@bloomberg.com'),
(nextval('seq_empleado_prof'), 'Torr', 'Bentame', 'Blinny', 'Hender', '1/23/2000', 79847252, 'bhender3m@nature.com'),
(nextval('seq_empleado_prof'), 'Maegan', 'Littlemore', 'Rickie', 'L''Episcopio', '2/13/1980', 74071679, 'rlepiscopio3n@github.io'),
(nextval('seq_empleado_prof'), 'Elihu', 'Gurys', 'Doroteya', 'Stemp', '12/12/2003', 67329231, 'dstemp3o@google.co.jp'),
(nextval('seq_empleado_prof'), 'Rana', 'Ashleigh', 'Lucas', 'Comber', '4/24/1969', 1804441, 'lcomber3p@weather.com'),
(nextval('seq_empleado_prof'), 'Sarene', 'Pealing', 'Joachim', 'Thundercliffe', '2/27/2004', 31413758, 'jthundercliffe3q@jiathis.com'),
(nextval('seq_empleado_prof'), 'Corrinne', 'Watkins', 'Meagan', 'Frowen', '12/3/1971', 92787151, 'mfrowen3r@prnewswire.com'),
(nextval('seq_empleado_prof'), 'Glenine', 'Astle', 'Nollie', 'Enders', '7/11/1977', 57299985, 'nenders3s@wix.com'),
(nextval('seq_empleado_prof'), 'Bertha', 'Mallam', 'Flinn', 'Chappell', '6/29/1980', 92275842, 'fchappell3t@microsoft.com'),
(nextval('seq_empleado_prof'), 'Stewart', 'Steadman', 'Kenyon', 'Rampley', '2/23/2001', 96570502, 'krampley3u@nba.com'),
(nextval('seq_empleado_prof'), 'Lucas', 'Robertet', 'Noell', 'Vasyutin', '3/31/2005', 6903042, 'nvasyutin3v@princeton.edu'),
(nextval('seq_empleado_prof'), 'Emyle', 'Melsom', 'Johnathan', 'Tythacott', '9/13/1991', 38176865, 'jtythacott3w@uol.com.br'),
(nextval('seq_empleado_prof'), 'Haskell', 'Penwarden', 'Shirleen', 'Jasiak', '8/22/1998', 70834184, 'sjasiak3x@zimbio.com'),
(nextval('seq_empleado_prof'), 'Alaster', 'Weippert', 'Ephrem', 'Temprell', '10/20/1977', 9067699, 'etemprell3y@epa.gov'),
(nextval('seq_empleado_prof'), 'Austin', 'MacVanamy', 'Homere', 'Cherry', '5/27/1968', 98183048, 'hcherry3z@cpanel.net'),
(nextval('seq_empleado_prof'), 'Anatola', 'Baskerfield', 'Kingston', 'Haville', '1/14/1989', 20200442, 'khaville40@posterous.com'),
(nextval('seq_empleado_prof'), 'Bear', 'Kristof', 'Kalvin', 'Kirkham', '5/30/1982', 87441231, 'kkirkham41@miitbeian.gov.cn'),
(nextval('seq_empleado_prof'), 'Tudor', 'Hallex', 'Ody', 'Abrahami', '4/11/1966', 55047468, 'oabrahami42@simplemachines.org'),
(nextval('seq_empleado_prof'), 'Milena', 'Padilla', 'Theodosia', 'Spadollini', '8/1/1997', 22527711, 'tspadollini43@nps.gov'),
(nextval('seq_empleado_prof'), 'Eugene', 'Cowl', 'Carlo', 'Reeve', '9/15/1980', 60726574, 'creeve44@booking.com'),
(nextval('seq_empleado_prof'), 'Kakalina', 'Eastup', 'Robinette', 'Peirson', '3/19/1985', 96013233, 'rpeirson45@europa.eu'),
(nextval('seq_empleado_prof'), 'Sarajane', 'Seton', 'Laureen', 'Paolicchi', '10/19/2004', 57606503, 'lpaolicchi46@usa.gov'),
(nextval('seq_empleado_prof'), 'Rube', 'Giddins', 'Gertie', 'Moberley', '6/22/1984', 89414948, 'gmoberley47@mediafire.com'),
(nextval('seq_empleado_prof'), 'Rodd', 'Luddy', 'Cordy', 'Luxmoore', '1/21/1999', 31023335, 'cluxmoore48@meetup.com'),
(nextval('seq_empleado_prof'), 'Dalt', 'Gateman', 'Tatiana', 'Perse', '6/30/1982', 14195540, 'tperse49@gov.uk'),
(nextval('seq_empleado_prof'), 'Brandyn', 'Burde', 'Marcellina', 'Tattershaw', '8/31/2003', 4500411, 'mtattershaw4a@sbwire.com'),
(nextval('seq_empleado_prof'), 'Mollie', 'Pilfold', 'Devora', 'Wayon', '5/2/1994', 68515666, 'dwayon4b@twitpic.com'),
(nextval('seq_empleado_prof'), 'Dane', 'Vernazza', 'Ortensia', 'Berrisford', '2/10/1984', 34143310, 'oberrisford4c@google.co.jp'),
(nextval('seq_empleado_prof'), 'Bastien', 'Hencke', 'Lexine', 'Arondel', '5/19/1979', 47248101, 'larondel4d@ebay.co.uk'),
(nextval('seq_empleado_prof'), 'Peta', 'Rittmeyer', 'Wernher', 'Dibdall', '6/11/1973', 26565035, 'wdibdall4e@t.co'),
(nextval('seq_empleado_prof'), 'Elwyn', 'Klosterman', 'Corrianne', 'Housegoe', '5/31/1969', 66099096, 'chousegoe4f@timesonline.co.uk');
...
insert into EMPLEADO_MANTENIMIENTO_VIGILANCIA (id_empleado_mantenimiento_vigilancia, primer_nombre, primer_apellido, doc_identidad, tipo) values (nextval('seq_empleado_mv'), 'Mira', 'Folder', 51174186, 'vigilancia');
insert into EMPLEADO_MANTENIMIENTO_VIGILANCIA (id_empleado_mantenimiento_vigilancia, primer_nombre, primer_apellido, doc_identidad, tipo) values (nextval('seq_empleado_mv'), 'Auberta', 'Fuchs', 26953561, 'mantenimiento');
insert into EMPLEADO_MANTENIMIENTO_VIGILANCIA (id_empleado_mantenimiento_vigilancia, primer_nombre, primer_apellido, doc_identidad, tipo) values (nextval('seq_empleado_mv'), 'Linc', 'Kennet', 1179298, 'vigilancia');
insert into EMPLEADO_MANTENIMIENTO_VIGILANCIA (id_empleado_mantenimiento_vigilancia, primer_nombre, primer_apellido, doc_identidad, tipo) values (nextval('seq_empleado_mv'), 'Farleigh', 'Claydon', 54780476, 'mantenimiento');
insert into EMPLEADO_MANTENIMIENTO_VIGILANCIA (id_empleado_mantenimiento_vigilancia, primer_nombre, primer_apellido, doc_identidad, tipo) values (nextval('seq_empleado_mv'), 'Aubrie', 'Dearth', 88501895, 'vigilancia');
insert into EMPLEADO_MANTENIMIENTO_VIGILANCIA (id_empleado_mantenimiento_vigilancia, primer_nombre, primer_apellido, doc_identidad, tipo) values (nextval('seq_empleado_mv'), 'Pascale', 'Ferschke', 62468660, 'mantenimiento');
insert into EMPLEADO_MANTENIMIENTO_VIGILANCIA (id_empleado_mantenimiento_vigilancia, primer_nombre, primer_apellido, doc_identidad, tipo) values (nextval('seq_empleado_mv'), 'Tansy', 'Vernay', 83107391, 'mantenimiento');
insert into EMPLEADO_MANTENIMIENTO_VIGILANCIA (id_empleado_mantenimiento_vigilancia, primer_nombre, primer_apellido, doc_identidad, tipo) values (nextval('seq_empleado_mv'), 'Edik', 'Hopewell', 3718806, 'vigilancia');
insert into EMPLEADO_MANTENIMIENTO_VIGILANCIA (id_empleado_mantenimiento_vigilancia, primer_nombre, primer_apellido, doc_identidad, tipo) values (nextval('seq_empleado_mv'), 'Alyse', 'Bannerman', 71772853, 'vigilancia');
insert into EMPLEADO_MANTENIMIENTO_VIGILANCIA (id_empleado_mantenimiento_vigilancia, primer_nombre, primer_apellido, doc_identidad, tipo) values (nextval('seq_empleado_mv'), 'Donica', 'McGlew', 20744975, 'vigilancia');
insert into EMPLEADO_MANTENIMIENTO_VIGILANCIA (id_empleado_mantenimiento_vigilancia, primer_nombre, primer_apellido, doc_identidad, tipo) values (nextval('seq_empleado_mv'), 'Nara', 'Point', 76042964, 'mantenimiento');
insert into EMPLEADO_MANTENIMIENTO_VIGILANCIA (id_empleado_mantenimiento_vigilancia, primer_nombre, primer_apellido, doc_identidad, tipo) values (nextval('seq_empleado_mv'), 'Duke', 'Sapwell', 23213194, 'vigilancia');
insert into EMPLEADO_MANTENIMIENTO_VIGILANCIA (id_empleado_mantenimiento_vigilancia, primer_nombre, primer_apellido, doc_identidad, tipo) values (nextval('seq_empleado_mv'), 'Nike', 'Fedynski', 45663684, 'vigilancia');
insert into EMPLEADO_MANTENIMIENTO_VIGILANCIA (id_empleado_mantenimiento_vigilancia, primer_nombre, primer_apellido, doc_identidad, tipo) values (nextval('seq_empleado_mv'), 'Rudyard', 'Butson', 67886612, 'vigilancia');
insert into EMPLEADO_MANTENIMIENTO_VIGILANCIA (id_empleado_mantenimiento_vigilancia, primer_nombre, primer_apellido, doc_identidad, tipo) values (nextval('seq_empleado_mv'), 'Sigfried', 'Manneville', 60756094, 'mantenimiento');
insert into EMPLEADO_MANTENIMIENTO_VIGILANCIA (id_empleado_mantenimiento_vigilancia, primer_nombre, primer_apellido, doc_identidad, tipo) values (nextval('seq_empleado_mv'), 'Adolf', 'Pautot', 18379753, 'vigilancia');
insert into EMPLEADO_MANTENIMIENTO_VIGILANCIA (id_empleado_mantenimiento_vigilancia, primer_nombre, primer_apellido, doc_identidad, tipo) values (nextval('seq_empleado_mv'), 'Travers', 'Motto', 9123269, 'mantenimiento');
insert into EMPLEADO_MANTENIMIENTO_VIGILANCIA (id_empleado_mantenimiento_vigilancia, primer_nombre, primer_apellido, doc_identidad, tipo) values (nextval('seq_empleado_mv'), 'Marley', 'Jeandin', 57427347, 'mantenimiento');
insert into EMPLEADO_MANTENIMIENTO_VIGILANCIA (id_empleado_mantenimiento_vigilancia, primer_nombre, primer_apellido, doc_identidad, tipo) values (nextval('seq_empleado_mv'), 'Alastair', 'Rubinfajn', 59739477, 'vigilancia');
insert into EMPLEADO_MANTENIMIENTO_VIGILANCIA (id_empleado_mantenimiento_vigilancia, primer_nombre, primer_apellido, doc_identidad, tipo) values (nextval('seq_empleado_mv'), 'Nan', 'Attarge', 60146158, 'vigilancia');
insert into EMPLEADO_MANTENIMIENTO_VIGILANCIA (id_empleado_mantenimiento_vigilancia, primer_nombre, primer_apellido, doc_identidad, tipo) values (nextval('seq_empleado_mv'), 'Ola', 'Skoyles', 10676993, 'vigilancia');
insert into EMPLEADO_MANTENIMIENTO_VIGILANCIA (id_empleado_mantenimiento_vigilancia, primer_nombre, primer_apellido, doc_identidad, tipo) values (nextval('seq_empleado_mv'), 'Karmen', 'Piddock', 87772909, 'vigilancia');
insert into EMPLEADO_MANTENIMIENTO_VIGILANCIA (id_empleado_mantenimiento_vigilancia, primer_nombre, primer_apellido, doc_identidad, tipo) values (nextval('seq_empleado_mv'), 'Sonni', 'Daleman', 77434190, 'vigilancia');
insert into EMPLEADO_MANTENIMIENTO_VIGILANCIA (id_empleado_mantenimiento_vigilancia, primer_nombre, primer_apellido, doc_identidad, tipo) values (nextval('seq_empleado_mv'), 'Shandeigh', 'Bone', 27240577, 'vigilancia');
insert into EMPLEADO_MANTENIMIENTO_VIGILANCIA (id_empleado_mantenimiento_vigilancia, primer_nombre, primer_apellido, doc_identidad, tipo) values (nextval('seq_empleado_mv'), 'Karalee', 'Vyvyan', 54961264, 'mantenimiento');
insert into EMPLEADO_MANTENIMIENTO_VIGILANCIA (id_empleado_mantenimiento_vigilancia, primer_nombre, primer_apellido, doc_identidad, tipo) values (nextval('seq_empleado_mv'), 'Augustine', 'Savell', 80828674, 'vigilancia');
insert into EMPLEADO_MANTENIMIENTO_VIGILANCIA (id_empleado_mantenimiento_vigilancia, primer_nombre, primer_apellido, doc_identidad, tipo) values (nextval('seq_empleado_mv'), 'Kiley', 'Zimmer', 15288606, 'vigilancia');
insert into EMPLEADO_MANTENIMIENTO_VIGILANCIA (id_empleado_mantenimiento_vigilancia, primer_nombre, primer_apellido, doc_identidad, tipo) values (nextval('seq_empleado_mv'), 'Zita', 'Corwood', 22974337, 'mantenimiento');
insert into EMPLEADO_MANTENIMIENTO_VIGILANCIA (id_empleado_mantenimiento_vigilancia, primer_nombre, primer_apellido, doc_identidad, tipo) values (nextval('seq_empleado_mv'), 'Gran', 'Bullan', 84710816, 'mantenimiento');
insert into EMPLEADO_MANTENIMIENTO_VIGILANCIA (id_empleado_mantenimiento_vigilancia, primer_nombre, primer_apellido, doc_identidad, tipo) values (nextval('seq_empleado_mv'), 'Pail', 'Odd', 33865961, 'vigilancia');
insert into EMPLEADO_MANTENIMIENTO_VIGILANCIA (id_empleado_mantenimiento_vigilancia, primer_nombre, primer_apellido, doc_identidad, tipo) values (nextval('seq_empleado_mv'), 'Sabine', 'Venediktov', 2643931, 'mantenimiento');
insert into EMPLEADO_MANTENIMIENTO_VIGILANCIA (id_empleado_mantenimiento_vigilancia, primer_nombre, primer_apellido, doc_identidad, tipo) values (nextval('seq_empleado_mv'), 'Darrick', 'Sommerville', 64394613, 'mantenimiento');
